...
.field private mRemoteUserInfo:Landroidx/media/c;
...
.field private mVolumeCallback:Landroidx/media/j$b;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;)V
    ...
    iput-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Landroidx/media/j$b;
...
.method adjustVolume(II)V
    ...
    .line 2
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/j;

    if-eqz p2, :cond_1

    .line 3
    invoke-virtual {p2, p1}, Landroidx/media/j;->a(I)V
...
.method public getCurrentControllerInfo()Landroidx/media/c;
    .locals 2
    ...
    .line 2
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Landroidx/media/c;
...
.method public setCurrentControllerInfo(Landroidx/media/c;)V
    .locals 1
    ...
    .line 2
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Landroidx/media/c;
...
.method public setPlaybackToLocal(I)V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/j;
    ...
    .line 2
    invoke-virtual {v0, v1}, Landroidx/media/j;->a(Landroidx/media/j$b;)V
...
.method public setPlaybackToRemote(Landroidx/media/j;)V
    ...
    .line 4
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/j;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/j;

    .line 6
    invoke-virtual {v1}, Landroidx/media/j;->c()I

    move-result v4

    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/j;

    invoke-virtual {v1}, Landroidx/media/j;->b()I
    ...
    .line 7
    invoke-virtual {v1}, Landroidx/media/j;->a()I
    ...
    .line 9
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Landroidx/media/j$b;

    invoke-virtual {p1, v0}, Landroidx/media/j;->a(Landroidx/media/j$b;)V
