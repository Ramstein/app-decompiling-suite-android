...
# direct methods
.method public constructor <init>(Ljava/lang/String;ILn/o;Ljavax/net/SocketFactory;Ljavax/net/ssl/SSLSocketFactory;Ljavax/net/ssl/HostnameVerifier;Ln/g;Ln/b;Ljava/net/Proxy;Ljava/util/List;Ljava/util/List;Ljava/net/ProxySelector;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    :goto_0
    invoke-virtual {v0, v1}, Ln/t$a;->f(Ljava/lang/String;)Ln/t$a;

    .line 4
    invoke-virtual {v0, p1}, Ln/t$a;->c(Ljava/lang/String;)Ln/t$a;

    .line 5
    invoke-virtual {v0, p2}, Ln/t$a;->a(I)Ln/t$a;
    ...
    iput-object p1, p0, Ln/a;->a:Ln/t;

    if-eqz p3, :cond_6

    .line 7
    iput-object p3, p0, Ln/a;->b:Ln/o;

    if-eqz p4, :cond_5

    .line 8
    iput-object p4, p0, Ln/a;->c:Ljavax/net/SocketFactory;

    if-eqz p8, :cond_4

    .line 9
    iput-object p8, p0, Ln/a;->d:Ln/b;

    if-eqz p10, :cond_3

    .line 10
    invoke-static {p10}, Ln/g0/c;->a(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Ln/a;->e:Ljava/util/List;

    if-eqz p11, :cond_2

    .line 11
    invoke-static {p11}, Ln/g0/c;->a(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Ln/a;->f:Ljava/util/List;

    if-eqz p12, :cond_1

    .line 12
    iput-object p12, p0, Ln/a;->g:Ljava/net/ProxySelector;

    .line 13
    iput-object p9, p0, Ln/a;->h:Ljava/net/Proxy;

    .line 14
    iput-object p5, p0, Ln/a;->i:Ljavax/net/ssl/SSLSocketFactory;

    .line 15
    iput-object p6, p0, Ln/a;->j:Ljavax/net/ssl/HostnameVerifier;

    .line 16
    iput-object p7, p0, Ln/a;->k:Ln/g;
...
.method a(Ln/a;)Z
    ...
    .line 2
    iget-object v0, p0, Ln/a;->b:Ln/o;

    iget-object v1, p1, Ln/a;->b:Ln/o;
    ...
    .line 7
    invoke-static {v0, v1}, Ln/g0/c;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public i()Ljavax/net/SocketFactory;
    ...
    .line 1
    iget-object v0, p0, Ln/a;->c:Ljavax/net/SocketFactory;
