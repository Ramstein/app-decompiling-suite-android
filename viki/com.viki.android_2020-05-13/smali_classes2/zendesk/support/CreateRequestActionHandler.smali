...
.method extractConfigs(Ljava/util/Map;)Ljava/util/List;
    ...
    .line 1
    const-class v0, Lzendesk/commonui/l;

    invoke-static {p1, v0}, Lzendesk/commonui/m;->a(Ljava/util/Map;Ljava/lang/Class;)Lzendesk/commonui/l;
    ...
    .line 2
    invoke-interface {p1}, Lzendesk/commonui/l;->getUiConfigs()Ljava/util/List;
...
.method public getActionDescription()Lzendesk/core/ActionDescription;
    ...
    sget v1, Lf/k/c/j;->zs_request_contact_option_leave_a_message:I
    ...
    sget v2, Lf/k/c/e;->zs_contact_leave_message:I
...
.method public handle(Ljava/util/Map;Landroid/content/Context;)V
    ...
    new-array v0, v0, [Lzendesk/commonui/l;

    invoke-virtual {p1, p2, v0}, Lzendesk/support/request/RequestUiConfig$Builder;->show(Landroid/content/Context;[Lzendesk/commonui/l;)V
