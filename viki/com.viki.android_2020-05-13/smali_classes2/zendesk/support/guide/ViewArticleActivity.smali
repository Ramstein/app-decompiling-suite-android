...
.field private attachmentRequestCallback:Lf/k/d/e;
...
.method private applyVoteButtonSettings()V
    ...
    invoke-direct {p0, v0}, Lzendesk/support/guide/ViewArticleActivity;->loadSettings(Lf/k/d/f;)V
...
.method private fetchArticle(J)V
    ...
    invoke-interface {v0, p1, p2}, Lzendesk/support/HelpCenterProvider;->getArticle(Ljava/lang/Long;Lf/k/d/f;)V
...
.method private fetchAttachmentsForArticle(J)V
    ...
    iget-object v1, p0, Lzendesk/support/guide/ViewArticleActivity;->attachmentRequestCallback:Lf/k/d/e;

    invoke-interface {v0, p1, p2, v1}, Lzendesk/support/HelpCenterProvider;->getAttachments(Ljava/lang/Long;Lzendesk/support/AttachmentType;Lf/k/d/f;)V
...
.method private initToolbar()Landroidx/appcompat/app/a;
    ...
    .line 1
    sget v0, Lf/k/c/f;->view_article_toolbar:I
    ...
    .line 3
    sget v1, Lf/k/c/f;->view_article_compat_shadow:I
...
.method private loadArticleBody()V
    ...
    .line 1
    sget v0, Lf/k/c/j;->zs_view_article_loaded_accessibility:I
    ...
    invoke-static {v0}, Ld/h/n/a;->a(Landroid/content/res/Configuration;)Ld/h/n/b;

    move-result-object v0

    invoke-virtual {v0, v4}, Ld/h/n/b;->a(I)Ljava/util/Locale;
    ...
    sget v2, Lf/k/c/j;->view_article_seperator:I
    ...
    .line 13
    :goto_0
    sget v2, Lf/k/c/j;->view_article_html_body:I
...
.method private loadSettings(Lf/k/d/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Lzendesk/support/AggregatedCallback;->add(Lf/k/d/f;)Z
    ...
    invoke-interface {p1, v0}, Lzendesk/support/SupportSettingsProvider;->getSettings(Lf/k/d/f;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    sget v0, Lf/k/c/k;->ZendeskActivityDefaultTheme:I
    ...
    .line 3
    sget p1, Lf/k/c/h;->zs_activity_view_article:I
    ...
    invoke-static {v3, v4}, Lzendesk/commonui/m;->a(Landroid/os/Bundle;Ljava/lang/Class;)Lzendesk/commonui/l;
    ...
    .line 10
    :cond_1
    sget v0, Lf/k/c/f;->view_article_attachment_list:I
    ...
    .line 16
    sget p1, Lf/k/c/f;->view_article_content_webview:I
    ...
    .line 24
    :cond_4
    sget p1, Lf/k/c/f;->view_article_progress:I
    ...
    .line 25
    sget p1, Lf/k/c/f;->view_article_attachment_coordinator:I
    ...
    .line 36
    :cond_7
    sget p1, Lf/k/c/f;->article_voting_container:I
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 10
    invoke-static {p2, p3, p1}, Lf/k/b/a;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method protected onStart()V
    ...
    invoke-static {v0}, Lf/k/d/e;->a(Lf/k/d/f;)Lf/k/d/e;

    move-result-object v0

    iput-object v0, p0, Lzendesk/support/guide/ViewArticleActivity;->attachmentRequestCallback:Lf/k/d/e;
...
.method protected onStop()V
    ...
    .line 2
    iget-object v0, p0, Lzendesk/support/guide/ViewArticleActivity;->attachmentRequestCallback:Lf/k/d/e;

    if-eqz v0, :cond_0

    .line 3
    invoke-virtual {v0}, Lf/k/d/e;->cancel()V
...
.method protected setLoadingState(Lzendesk/support/guide/ViewArticleActivity$LoadingState;)V
    ...
    sget v0, Lf/k/c/j;->view_article_attachments_error:I
