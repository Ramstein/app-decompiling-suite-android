...
.field private final requestExtractor:Lf/k/d/d$b;
...
.field private final requestsExtractor:Lf/k/d/d$b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lf/k/d/d$b<",
...
.method constructor <init>(Lzendesk/support/RequestService;)V
    ...
    iput-object v0, p0, Lzendesk/support/ZendeskRequestService;->requestsExtractor:Lf/k/d/d$b;
    ...
    iput-object v0, p0, Lzendesk/support/ZendeskRequestService;->requestExtractor:Lf/k/d/d$b;
...
# virtual methods
.method addComment(Ljava/lang/String;Lzendesk/support/EndUserComment;Lf/k/d/f;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-interface {p2, p1, v0}, Lzendesk/support/RequestService;->addComment(Ljava/lang/String;Lzendesk/support/UpdateRequestWrapper;)Lq/b;
...
.method public createRequest(Ljava/lang/String;Lzendesk/support/CreateRequest;Lf/k/d/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    invoke-interface {p2, p1, v0}, Lzendesk/support/RequestService;->createRequest(Ljava/lang/String;Lzendesk/support/CreateRequestWrapper;)Lq/b;
...
.method getAllRequests(Ljava/lang/String;Ljava/lang/String;Lf/k/d/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-interface {v0, p1, p2}, Lzendesk/support/RequestService;->getAllRequests(Ljava/lang/String;Ljava/lang/String;)Lq/b;

    move-result-object p1

    new-instance p2, Lf/k/d/d;

    iget-object v0, p0, Lzendesk/support/ZendeskRequestService;->requestsExtractor:Lf/k/d/d$b;
...
.method getAllRequests(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lf/k/d/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    invoke-interface {v0, p1, p2, p3}, Lzendesk/support/RequestService;->getManyRequests(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lq/b;

    move-result-object p1

    new-instance p2, Lf/k/d/d;

    iget-object p3, p0, Lzendesk/support/ZendeskRequestService;->requestsExtractor:Lf/k/d/d$b;
...
.method getComments(Ljava/lang/String;Lf/k/d/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-interface {v0, p1}, Lzendesk/support/RequestService;->getComments(Ljava/lang/String;)Lq/b;
...
.method getCommentsSince(Ljava/lang/String;Ljava/util/Date;ZLf/k/d/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    invoke-interface {v0, p1, p2, p3}, Lzendesk/support/RequestService;->getCommentsSince(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lq/b;
...
.method getRequest(Ljava/lang/String;Ljava/lang/String;Lf/k/d/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-interface {v0, p1, p2}, Lzendesk/support/RequestService;->getRequest(Ljava/lang/String;Ljava/lang/String;)Lq/b;

    move-result-object p1

    new-instance p2, Lf/k/d/d;

    iget-object v0, p0, Lzendesk/support/ZendeskRequestService;->requestExtractor:Lf/k/d/d$b;
