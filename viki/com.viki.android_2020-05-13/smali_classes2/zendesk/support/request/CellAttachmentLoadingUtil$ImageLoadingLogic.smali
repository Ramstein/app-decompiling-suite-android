...
# instance fields
.field private final picasso:Lf/h/a/d;


# direct methods
.method constructor <init>(Lf/h/a/d;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic;->picasso:Lf/h/a/d;

    return-void
.end method

.method static synthetic access$500(Landroid/widget/ImageView;Lf/h/a/g;Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$ImageDimensions;Lf/h/a/a;)V
    .locals 0

    .line 1
    invoke-static {p0, p1, p2, p3}, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic;->loadImage(Landroid/widget/ImageView;Lf/h/a/g;Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$ImageDimensions;Lf/h/a/a;)V
...
.method private getLoadingStrategy(Lzendesk/support/request/StateRequestAttachment;)Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic$LoadingStrategy;
    ...
    iget-object v2, p0, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic;->picasso:Lf/h/a/d;

    invoke-virtual {p1}, Lzendesk/support/request/StateRequestAttachment;->getLocalFile()Ljava/io/File;

    move-result-object p1

    invoke-interface {v2, p1}, Lf/h/a/d;->a(Ljava/io/File;)Lf/h/a/g;

    move-result-object p1

    invoke-direct {v0, p1, v1}, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic$DisplayImageFromLocalSource;-><init>(Lf/h/a/g;Lzendesk/support/request/CellAttachmentLoadingUtil$1;)V
    ...
    invoke-interface {v2, p1}, Lf/h/a/d;->a(Landroid/net/Uri;)Lf/h/a/g;
    ...
    invoke-direct {v0, v2, v3, p1, v1}, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic$DisplayImageFromWeb;-><init>(Lf/h/a/d;Ljava/lang/String;Ljava/lang/String;Lzendesk/support/request/CellAttachmentLoadingUtil$1;)V
    ...
    invoke-static {p1, v2, v0}, Lf/k/b/a;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static loadImage(Landroid/widget/ImageView;Lf/h/a/g;Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$ImageDimensions;Lf/h/a/a;)V
    .locals 3
    ...
    sget v2, Lf/k/c/d;->zs_request_attachment_corner_radius:I
    ...
    .line 4
    invoke-static {v1}, Lzendesk/support/PicassoTransformations;->getRoundedTransformation(I)Lf/h/a/i;

    move-result-object v1

    invoke-interface {p1, v1}, Lf/h/a/g;->a(Lf/h/a/i;)Lf/h/a/g;
    ...
    .line 5
    invoke-interface {p1, v0, p2}, Lf/h/a/g;->a(II)Lf/h/a/g;

    move-result-object p1

    .line 6
    invoke-interface {p1}, Lf/h/a/g;->d()Lf/h/a/g;

    move-result-object p1

    .line 7
    invoke-interface {p1, p0, p3}, Lf/h/a/g;->a(Landroid/widget/ImageView;Lf/h/a/a;)V
...
.method initImageView(Landroid/widget/ImageView;)V
    ...
    .line 1
    iget-object v0, p0, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic;->picasso:Lf/h/a/d;

    invoke-interface {v0, p1}, Lf/h/a/d;->a(Landroid/widget/ImageView;)V

    .line 2
    sget v0, Lf/k/c/c;->zs_color_transparent:I
