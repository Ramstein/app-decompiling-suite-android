...
.field private final fadeTransition:Ld/u/d;
...
# direct methods
.method constructor <init>(Lf/h/a/d;Landroidx/appcompat/widget/Toolbar;Lzendesk/support/request/ViewAlmostRealProgressBar;)V
    .locals 1
    ...
    invoke-direct {v0}, Ld/u/d;-><init>()V

    iput-object v0, p0, Lzendesk/support/request/ComponentToolbar;->fadeTransition:Ld/u/d;

    .line 3
    iput-object p1, p0, Lzendesk/support/request/ComponentToolbar;->picasso:Lf/h/a/d;
    ...
    .line 8
    sget p1, Lf/k/c/f;->activity_request_toolbar_container:I
    ...
    .line 9
    sget p1, Lf/k/c/f;->activity_request_toolbar_custom_title:I
    ...
    .line 10
    sget p1, Lf/k/c/f;->activity_request_toolbar_custom_sub_title:I
    ...
    .line 11
    sget p1, Lf/k/c/f;->activity_request_toolbar_avatar_holder:I
...
.method private updateToolbar(Lzendesk/support/request/ComponentToolbar$ToolbarModel;)V
    ...
    sget v5, Lf/k/c/j;->request_toolbar_last_reply:I
    ...
    iget-object v3, p0, Lzendesk/support/request/ComponentToolbar;->picasso:Lf/h/a/d;

    invoke-virtual {p1}, Lzendesk/support/request/ComponentToolbar$ToolbarModel;->getAvatarUrls()Ljava/util/List;

    move-result-object v4

    invoke-virtual {v2, v3, v4}, Lzendesk/support/request/ViewToolbarAvatar;->setImageUrls(Lf/h/a/d;Ljava/util/List;)V

    .line 11
    iget-object v2, p0, Lzendesk/support/request/ComponentToolbar;->toolbar:Landroidx/appcompat/widget/Toolbar;

    iget-object v3, p0, Lzendesk/support/request/ComponentToolbar;->fadeTransition:Ld/u/d;

    invoke-static {v2, v3}, Ld/u/o;->a(Landroid/view/ViewGroup;Ld/u/m;)V
    ...
    sget v3, Lf/k/c/j;->zs_request_toolbar_accessibility:I
    ...
    sget v0, Lf/k/c/j;->request_activity_title:I
