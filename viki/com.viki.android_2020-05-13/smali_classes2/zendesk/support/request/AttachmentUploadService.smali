...
.field private resultListener:Lf/k/d/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lf/k/d/f<",
            "Lzendesk/support/request/AttachmentUploadService$AttachmentUploadResult;",
...
.method private isUploadFinished()Z
    ...
    invoke-static {v1}, Lf/k/e/a;->b(Ljava/util/Collection;)Z
...
.method private notifyIfFinished()V
    ...
    .line 1
    iget-object v1, p0, Lzendesk/support/request/AttachmentUploadService;->resultListener:Lf/k/d/f;
    ...
    iget-object v0, p0, Lzendesk/support/request/AttachmentUploadService;->resultListener:Lf/k/d/f;
    ...
    invoke-static {v0}, Lf/k/e/a;->a(Ljava/util/Collection;)Z
    ...
    invoke-static {v2}, Lf/k/e/a;->a(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v0, v1}, Lf/k/d/f;->onSuccess(Ljava/lang/Object;)V
    ...
    new-instance v1, Lf/k/d/b;

    const-string v2, "Error uploading attachments."

    invoke-direct {v1, v2}, Lf/k/d/b;-><init>(Ljava/lang/String;)V

    invoke-virtual {v0, v1}, Lf/k/d/f;->onError(Lf/k/d/a;)V

    :goto_0
    const/4 v0, 0x0

    .line 8
    iput-object v0, p0, Lzendesk/support/request/AttachmentUploadService;->resultListener:Lf/k/d/f;
...
.method private renameFile(Ljava/io/File;J)Lzendesk/belvedere/r;
    ...
    .line 3
    invoke-virtual {v0, p2, p3}, Lzendesk/belvedere/a;->a(Ljava/lang/String;Ljava/lang/String;)Lzendesk/belvedere/r;
    ...
    .line 5
    invoke-virtual {p2}, Lzendesk/belvedere/r;->a()Ljava/io/File;
    ...
    .line 6
    invoke-static {v0, v1, p3}, Lf/k/b/a;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private updateRequestAttachment(Lzendesk/support/request/StateRequestAttachment;Lzendesk/belvedere/r;)Lzendesk/support/request/StateRequestAttachment;
    ...
    .line 3
    invoke-virtual {p2}, Lzendesk/belvedere/r;->d()Ljava/lang/String;
    ...
    .line 4
    invoke-virtual {p2}, Lzendesk/belvedere/r;->c()Ljava/lang/String;
    ...
    .line 5
    invoke-virtual {p2}, Lzendesk/belvedere/r;->h()Landroid/net/Uri;
...
.method private uploadAttachment(Lzendesk/support/request/StateRequestAttachment;)V
    ...
    .line 7
    invoke-virtual {p1, v0, v2, v1}, Lzendesk/belvedere/a;->a(Ljava/util/List;Ljava/lang/String;Lzendesk/belvedere/d;)V
...
.method private uploadSuccess(Lzendesk/support/request/StateRequestAttachment;Lzendesk/support/UploadResponse;)V
    ...
    .line 3
    invoke-virtual {v1}, Lzendesk/belvedere/r;->h()Landroid/net/Uri;
...
# virtual methods
.method setResultListener(Lf/k/d/f;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    iput-object p1, p0, Lzendesk/support/request/AttachmentUploadService;->resultListener:Lf/k/d/f;
