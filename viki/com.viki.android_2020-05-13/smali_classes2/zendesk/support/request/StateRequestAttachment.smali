...
.method static convert(Ljava/util/List;Ljava/util/Map;Lzendesk/support/request/StateIdMapper;)Ld/h/q/d;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    :cond_0
    invoke-static {v0, p2, p1}, Lzendesk/support/request/StateRequestAttachment;->convert(Ljava/util/List;Lzendesk/support/request/StateIdMapper;Ljava/util/Map;)Ld/h/q/d;
...
.method static convert(Ljava/util/List;Lzendesk/support/request/StateIdMapper;Ljava/util/Map;)Ld/h/q/d;
    .locals 23
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 14
    invoke-virtual {v5}, Lzendesk/belvedere/r;->a()Ljava/io/File;

    move-result-object v6

    .line 15
    invoke-virtual {v5}, Lzendesk/belvedere/r;->h()Landroid/net/Uri;
    ...
    invoke-static {v5}, Lf/k/e/a;->b(Ljava/util/Collection;)Z
    ...
    .line 25
    :cond_7
    invoke-static {v2, v0}, Ld/h/q/d;->a(Ljava/lang/Object;Ljava/lang/Object;)Ld/h/q/d;
...
.method static convert(Lzendesk/belvedere/r;)Lzendesk/support/request/StateRequestAttachment;
    ...
    .line 28
    invoke-virtual {p0}, Lzendesk/belvedere/r;->h()Landroid/net/Uri;
    ...
    .line 29
    invoke-virtual {p0}, Lzendesk/belvedere/r;->a()Ljava/io/File;

    move-result-object v4

    .line 30
    invoke-virtual {p0}, Lzendesk/belvedere/r;->c()Ljava/lang/String;

    move-result-object v7

    .line 31
    invoke-virtual {p0}, Lzendesk/belvedere/r;->d()Ljava/lang/String;

    move-result-object v8

    .line 32
    invoke-virtual {p0}, Lzendesk/belvedere/r;->f()J

    move-result-wide v9

    .line 33
    invoke-virtual {p0}, Lzendesk/belvedere/r;->n()J
    ...
    .line 34
    invoke-virtual {p0}, Lzendesk/belvedere/r;->b()J
