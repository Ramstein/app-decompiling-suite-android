...
.method constructor <init>(Landroid/content/Context;Lf/h/a/d;Lzendesk/support/request/ActionFactory;Lt/a/f;)V
    .locals 0
    ...
    invoke-direct {p3, p2, p1}, Lzendesk/support/request/CellAttachmentLoadingUtil;-><init>(Lf/h/a/d;Landroid/content/Context;)V
    ...
    .line 6
    sget p2, Lf/k/c/j;->request_message_date_today:I
    ...
    .line 7
    sget p2, Lf/k/c/j;->request_message_date_yesterday:I
...
.method private openAttachment(Landroid/content/Context;Lzendesk/support/request/StateRequestAttachment;)V
    ...
    .line 1
    invoke-static {p1}, Lzendesk/belvedere/a;->a(Landroid/content/Context;)Lzendesk/belvedere/a;
    ...
    invoke-virtual {v0, v1, p2}, Lzendesk/belvedere/a;->a(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Intent;
...
.method addOnClickListenerForFileAttachment(Landroid/view/View;Lzendesk/support/request/StateRequestAttachment;)V
    ...
    sget v0, Lf/k/c/g;->zs_request_file_attachment_downloading_cell_alpha:I
...
.method bindStatusLabel(Landroid/widget/TextView;ZZ)V
    ...
    .line 2
    sget p2, Lf/k/c/j;->request_messages_status_error:I
    ...
    .line 3
    sget v0, Lf/k/c/c;->zs_request_cell_label_color:I

    .line 4
    sget p2, Lf/k/c/j;->request_message_status_delivered:I
    ...
    .line 11
    invoke-static {v0, v0, v2, p3}, Ld/h/r/h0/b;->a(FFFF)Landroid/view/animation/Interpolator;
...
.method colorForError(Z)I
    ...
    .line 1
    sget p1, Lf/k/c/c;->zs_request_user_background_color_error:I

    goto :goto_0

    .line 2
    :cond_0
    sget p1, Lf/k/c/c;->zs_request_user_background_color:I
...
.method colorForErrorImage(Z)I
    ...
    sget v0, Lf/k/c/c;->zs_request_user_background_image_color_error:I
