...
# instance fields
.field private final uiConfig:Lzendesk/commonui/l;


# direct methods
.method constructor <init>(Lzendesk/commonui/l;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lzendesk/support/request/RequestModule;->uiConfig:Lzendesk/commonui/l;
...
.method static providesAttachmentToDiskService(Ln/x;Ljava/util/concurrent/ExecutorService;)Lzendesk/support/request/AttachmentDownloadService;
    .locals 1

    .line 1
    new-instance v0, Lzendesk/support/request/AttachmentDownloadService;

    invoke-direct {v0, p0, p1}, Lzendesk/support/request/AttachmentDownloadService;-><init>(Ln/x;Ljava/util/concurrent/Executor;)V
...
.method static providesBelvedere(Landroid/content/Context;)Lzendesk/belvedere/a;
    ...
    .line 1
    invoke-static {p0}, Lzendesk/belvedere/a;->a(Landroid/content/Context;)Lzendesk/belvedere/a;
...
.method static providesStore(Ljava/util/List;Lzendesk/support/request/AsyncMiddleware;)Lt/a/q;
    ...
    .line 1
    invoke-static {p0}, Lt/a/r;->a(Ljava/util/Collection;)Lt/a/r$a;
    ...
    .line 2
    invoke-virtual {p0, v0}, Lt/a/r$a;->a([Lt/a/m;)Lt/a/r$a;

    sget-object p1, Lt/a/i;->b:Lt/a/h;

    .line 3
    invoke-virtual {p0, p1}, Lt/a/r$a;->a(Lt/a/h;)Lt/a/r$a;

    .line 4
    invoke-virtual {p0}, Lt/a/r$a;->a()Lt/a/q;
...
# virtual methods
.method providesMessageFactory(Landroid/content/Context;Lf/h/a/d;Lzendesk/support/request/ActionFactory;Lt/a/f;Lzendesk/support/ZendeskDeepLinkHelper;)Lzendesk/support/request/CellFactory;
    .locals 8
    ...
    iget-object v6, p0, Lzendesk/support/request/RequestModule;->uiConfig:Lzendesk/commonui/l;
    ...
    invoke-direct/range {v0 .. v6}, Lzendesk/support/request/CellFactory;-><init>(Landroid/content/Context;Lf/h/a/d;Lzendesk/support/request/ActionFactory;Lt/a/f;Lzendesk/support/ZendeskDeepLinkHelper;Lzendesk/commonui/l;)V
