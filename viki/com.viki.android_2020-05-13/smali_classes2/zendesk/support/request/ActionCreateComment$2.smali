...
.method public onError(Lf/k/d/a;)V
    ...
    .line 2
    invoke-static {v2, v5, v1}, Lf/k/b/a;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 3
    invoke-interface {p1}, Lf/k/d/a;->g()Z
    ...
    invoke-virtual {v2, p1}, Lzendesk/support/request/StateMessage;->withError(Lf/k/d/a;)Lzendesk/support/request/StateMessage;

    move-result-object v2

    invoke-virtual {v1, p1, v2}, Lzendesk/support/request/ActionFactory;->createCommentError(Lf/k/d/a;Lzendesk/support/request/StateMessage;)Lt/a/a;
