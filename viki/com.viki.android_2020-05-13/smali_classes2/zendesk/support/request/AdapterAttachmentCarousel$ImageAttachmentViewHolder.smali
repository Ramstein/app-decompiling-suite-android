...
# direct methods
.method constructor <init>(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Lf/h/a/d;)V
    .locals 2

    .line 1
    sget v0, Lf/k/c/h;->zs_request_carousel_image:I
    ...
    sget p2, Lf/k/c/f;->request_attachment_carousel_image:I
    ...
    sget p2, Lf/k/c/f;->request_attachment_carousel_remove:I
    ...
    sget p2, Lf/k/c/f;->request_attachment_image_carousel_container:I
    ...
    .line 5
    iput-object p3, p0, Lzendesk/support/request/AdapterAttachmentCarousel$ImageAttachmentViewHolder;->picasso:Lf/h/a/d;
...
.method bind(Lzendesk/support/request/StateRequestAttachment;Lzendesk/support/request/AdapterAttachmentCarousel$CarouselViewHolder$OnRemoveListener;)V
    ...
    .line 1
    iget-object v0, p0, Lzendesk/support/request/AdapterAttachmentCarousel$ImageAttachmentViewHolder;->picasso:Lf/h/a/d;

    invoke-virtual {p1}, Lzendesk/support/request/StateRequestAttachment;->getParsedLocalUri()Landroid/net/Uri;

    move-result-object v1

    invoke-interface {v0, v1}, Lf/h/a/d;->a(Landroid/net/Uri;)Lf/h/a/g;

    move-result-object v0

    .line 2
    invoke-interface {v0}, Lf/h/a/g;->a()Lf/h/a/g;

    move-result-object v0

    .line 3
    invoke-interface {v0}, Lf/h/a/g;->d()Lf/h/a/g;
    ...
    .line 4
    invoke-interface {v0, v1}, Lf/h/a/g;->a(Landroid/widget/ImageView;)V
    ...
    sget v1, Lf/k/c/j;->zs_request_attachment_carousel_remove_attachment_accessibility:I
    ...
    sget v1, Lf/k/c/j;->zs_request_attachment_carousel_attachment_accessibility:I
