...
.method static synthetic access$1100(Lzendesk/support/ZendeskRequestProvider;Ljava/lang/String;Lzendesk/support/EndUserComment;Lf/k/d/f;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lzendesk/support/ZendeskRequestProvider;->addCommentInternal(Ljava/lang/String;Lzendesk/support/EndUserComment;Lf/k/d/f;)V
...
.method static synthetic access$300(Lzendesk/support/ZendeskRequestProvider;Lzendesk/support/CreateRequest;Lzendesk/core/AuthenticationType;Lzendesk/core/Identity;Lf/k/d/f;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Lzendesk/support/ZendeskRequestProvider;->internalCreateRequest(Lzendesk/support/CreateRequest;Lzendesk/core/AuthenticationType;Lzendesk/core/Identity;Lf/k/d/f;)V
...
.method static synthetic access$800(Lzendesk/support/ZendeskRequestProvider;Ljava/lang/String;Lzendesk/core/AuthenticationType;Lf/k/d/f;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lzendesk/support/ZendeskRequestProvider;->getAllRequestsInternal(Ljava/lang/String;Lzendesk/core/AuthenticationType;Lf/k/d/f;)V

    return-void
.end method

.method static synthetic access$900(Lf/k/d/f;)V
    .locals 0

    .line 1
    invoke-static {p0}, Lzendesk/support/ZendeskRequestProvider;->answerCallbackOnConversationsDisabled(Lf/k/d/f;)V

    return-void
.end method

.method private addCommentInternal(Ljava/lang/String;Lzendesk/support/EndUserComment;Lf/k/d/f;)V
    .locals 2
    ...
    invoke-direct {v1, p0, p3, p1, p3}, Lzendesk/support/ZendeskRequestProvider$7;-><init>(Lzendesk/support/ZendeskRequestProvider;Lf/k/d/f;Ljava/lang/String;Lf/k/d/f;)V

    invoke-virtual {v0, p1, p2, v1}, Lzendesk/support/ZendeskRequestService;->addComment(Ljava/lang/String;Lzendesk/support/EndUserComment;Lf/k/d/f;)V
...
.method private addServerTags(Lzendesk/support/CreateRequest;Lzendesk/support/SupportSdkSettings;)V
    ...
    .line 4
    invoke-static {p2}, Lf/k/e/a;->b(Ljava/util/Collection;)Z
...
.method private static answerCallbackOnConversationsDisabled(Lf/k/d/f;)V
    .locals 3
    ...
    invoke-direct {v0, v1}, Lf/k/d/b;-><init>(Ljava/lang/String;)V

    invoke-virtual {p0, v0}, Lf/k/d/f;->onError(Lf/k/d/a;)V
...
.method private getAllRequestsInternal(Ljava/lang/String;Lzendesk/core/AuthenticationType;Lf/k/d/f;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p1}, Lf/k/e/e;->c(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, p0, p3, p3}, Lzendesk/support/ZendeskRequestProvider$3;-><init>(Lzendesk/support/ZendeskRequestProvider;Lf/k/d/f;Lf/k/d/f;)V
    ...
    .line 8
    :cond_1
    invoke-static {v1}, Lf/k/e/a;->a(Ljava/util/Collection;)Z
    ...
    invoke-virtual {p3, p1}, Lf/k/d/f;->onSuccess(Ljava/lang/Object;)V
    ...
    .line 12
    invoke-static {v1}, Lf/k/e/e;->a(Ljava/util/List;)Ljava/lang/String;

    move-result-object p3

    invoke-virtual {p2, p3, p1, v2, v0}, Lzendesk/support/ZendeskRequestService;->getAllRequests(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lf/k/d/f;)V
    ...
    invoke-virtual {p2, p1, v2, v0}, Lzendesk/support/ZendeskRequestService;->getAllRequests(Ljava/lang/String;Ljava/lang/String;Lf/k/d/f;)V
...
.method private internalCreateRequest(Lzendesk/support/CreateRequest;Lzendesk/core/AuthenticationType;Lzendesk/core/Identity;Lf/k/d/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p4, p4}, Lzendesk/support/ZendeskRequestProvider$2;-><init>(Lzendesk/support/ZendeskRequestProvider;Lf/k/d/f;Lf/k/d/f;)V
    ...
    invoke-virtual {p3, p2, p1, v0}, Lzendesk/support/ZendeskRequestService;->createRequest(Ljava/lang/String;Lzendesk/support/CreateRequest;Lf/k/d/f;)V
    ...
    invoke-virtual {p2, p3, p1, v0}, Lzendesk/support/ZendeskRequestService;->createRequest(Ljava/lang/String;Lzendesk/support/CreateRequest;Lf/k/d/f;)V
...
# virtual methods
.method public addComment(Ljava/lang/String;Lzendesk/support/EndUserComment;Lf/k/d/f;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v1 .. v6}, Lzendesk/support/ZendeskRequestProvider$8;-><init>(Lzendesk/support/ZendeskRequestProvider;Lf/k/d/f;Ljava/lang/String;Lzendesk/support/EndUserComment;Lf/k/d/f;)V

    invoke-interface {v0, v7}, Lzendesk/support/SupportSettingsProvider;->getSettings(Lf/k/d/f;)V

    return-void
.end method

.method public createRequest(Lzendesk/support/CreateRequest;Lf/k/d/f;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p2, p1, p2}, Lzendesk/support/ZendeskRequestProvider$1;-><init>(Lzendesk/support/ZendeskRequestProvider;Lf/k/d/f;Lzendesk/support/CreateRequest;Lf/k/d/f;)V

    invoke-interface {v0, v1}, Lzendesk/support/SupportSettingsProvider;->getSettings(Lf/k/d/f;)V

    return-void
.end method

.method public getAllRequests(Lf/k/d/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-virtual {p0, v0, p1}, Lzendesk/support/ZendeskRequestProvider;->getRequests(Ljava/lang/String;Lf/k/d/f;)V

    return-void
.end method

.method public getComments(Ljava/lang/String;Lf/k/d/f;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p2, p1, p2}, Lzendesk/support/ZendeskRequestProvider$5;-><init>(Lzendesk/support/ZendeskRequestProvider;Lf/k/d/f;Ljava/lang/String;Lf/k/d/f;)V
...
.method public getCommentsSince(Ljava/lang/String;Ljava/util/Date;ZLf/k/d/f;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v1 .. v7}, Lzendesk/support/ZendeskRequestProvider$6;-><init>(Lzendesk/support/ZendeskRequestProvider;Lf/k/d/f;Ljava/lang/String;Ljava/util/Date;ZLf/k/d/f;)V

    invoke-interface {v0, v8}, Lzendesk/support/SupportSettingsProvider;->getSettings(Lf/k/d/f;)V

    return-void
.end method

.method public getRequest(Ljava/lang/String;Lf/k/d/f;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p2, p1, p2}, Lzendesk/support/ZendeskRequestProvider$9;-><init>(Lzendesk/support/ZendeskRequestProvider;Lf/k/d/f;Ljava/lang/String;Lf/k/d/f;)V
...
.method public getRequests(Ljava/lang/String;Lf/k/d/f;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p2, p1, p2}, Lzendesk/support/ZendeskRequestProvider$4;-><init>(Lzendesk/support/ZendeskRequestProvider;Lf/k/d/f;Ljava/lang/String;Lf/k/d/f;)V
...
.method public getUpdatesForDevice(Lf/k/d/f;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p1}, Lzendesk/support/ZendeskRequestProvider$11;-><init>(Lzendesk/support/ZendeskRequestProvider;Lf/k/d/f;)V
