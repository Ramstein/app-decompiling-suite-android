...
.method private a(Landroid/content/Context;I)Ld/h/q/d;
    .locals 20
    ...
    invoke-virtual {v2, v1}, Lzendesk/belvedere/y;->a(Landroid/content/Context;)Ljava/io/File;
    ...
    .line 38
    invoke-static {v3, v1}, Lzendesk/belvedere/p;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v1, v4}, Lzendesk/belvedere/y;->a(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    ...
    invoke-virtual {v3, v1, v15, v6, v7}, Lzendesk/belvedere/y;->a(Landroid/content/Context;Landroid/content/Intent;Landroid/net/Uri;I)V
    ...
    .line 47
    :goto_0
    invoke-static {v1, v6}, Lzendesk/belvedere/y;->b(Landroid/content/Context;Landroid/net/Uri;)Lzendesk/belvedere/r;
    ...
    invoke-virtual {v1}, Lzendesk/belvedere/r;->c()Ljava/lang/String;

    move-result-object v8

    invoke-virtual {v1}, Lzendesk/belvedere/r;->f()J

    move-result-wide v9

    invoke-virtual {v1}, Lzendesk/belvedere/r;->n()J

    move-result-wide v11

    invoke-virtual {v1}, Lzendesk/belvedere/r;->b()J
    ...
    invoke-direct {v2, v3, v1}, Ld/h/q/d;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method private a(Landroid/content/Context;)Z
    ...
    .line 7
    invoke-direct {p0, p1}, Lzendesk/belvedere/s;->b(Landroid/content/Context;)Z
...
.method private b(Landroid/content/Context;)Z
    ...
    .line 6
    :goto_1
    invoke-direct {p0, v0, p1}, Lzendesk/belvedere/s;->a(Landroid/content/Intent;Landroid/content/Context;)Z
...
.method private c(Landroid/content/Context;)Z
    ...
    .line 1
    invoke-direct {p0, v0, v1}, Lzendesk/belvedere/s;->a(Ljava/lang/String;Z)Landroid/content/Intent;
...
.method a(I)Ld/h/q/d;
    ...
    invoke-direct {p0, v0, p1}, Lzendesk/belvedere/s;->a(Landroid/content/Context;I)Ld/h/q/d;
    ...
    invoke-direct {p1, v0, v1}, Ld/h/q/d;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    return-object p1
.end method

.method a(ILjava/lang/String;Z)Lzendesk/belvedere/q;
    .locals 7

    .line 1
    iget-object v0, p0, Lzendesk/belvedere/s;->c:Landroid/content/Context;

    invoke-direct {p0, v0}, Lzendesk/belvedere/s;->c(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, p2, p3}, Lzendesk/belvedere/s;->a(Ljava/lang/String;Z)Landroid/content/Intent;
...
.method a(Landroid/content/Context;IILandroid/content/Intent;Lzendesk/belvedere/d;Z)V
    .locals 24
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 10
    invoke-virtual {v6}, Lzendesk/belvedere/r;->a()Ljava/io/File;
    ...
    invoke-virtual {v6}, Lzendesk/belvedere/r;->h()Landroid/net/Uri;
    ...
    invoke-virtual {v12, v1, v13, v7}, Lzendesk/belvedere/y;->a(Landroid/content/Context;Landroid/net/Uri;I)V
    ...
    invoke-static {v1, v3}, Lzendesk/belvedere/y;->b(Landroid/content/Context;Landroid/net/Uri;)Lzendesk/belvedere/r;
    ...
    invoke-virtual {v6}, Lzendesk/belvedere/r;->e()Landroid/net/Uri;

    move-result-object v15

    invoke-virtual {v6}, Lzendesk/belvedere/r;->d()Ljava/lang/String;
    ...
    .line 18
    invoke-direct {v0, v2}, Lzendesk/belvedere/s;->a(Landroid/content/Intent;)Ljava/util/List;
    ...
    invoke-static {v1, v3, v4, v2}, Lzendesk/belvedere/x;->a(Landroid/content/Context;Lzendesk/belvedere/y;Lzendesk/belvedere/d;Ljava/util/List;)V
