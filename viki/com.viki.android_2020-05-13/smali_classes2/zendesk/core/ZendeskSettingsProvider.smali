...
.method private getSettingsInternal(Ljava/util/Locale;)Ljava/util/Map;
    ...
    .line 6
    invoke-static {p1}, Lf/k/e/d;->a(Ljava/util/Locale;)Ljava/lang/String;

    move-result-object p1

    iget-object v2, p0, Lzendesk/core/ZendeskSettingsProvider;->applicationId:Ljava/lang/String;

    invoke-interface {v1, p1, v2}, Lzendesk/core/SdkSettingsService;->getSettings(Ljava/lang/String;Ljava/lang/String;)Lq/b;

    move-result-object p1

    invoke-interface {p1}, Lq/b;->b()Lq/l;

    move-result-object p1

    .line 7
    invoke-virtual {p1}, Lq/l;->a()Ljava/lang/Object;
    ...
    .line 10
    invoke-static {v1, v2, p1}, Lf/k/b/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private getSettingsInternal(Ljava/util/Locale;Lf/k/d/f;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, p1, v1}, Lzendesk/core/SdkSettingsService;->getSettings(Ljava/lang/String;Ljava/lang/String;)Lq/b;
...
.method public getSettingsForSdk(Ljava/lang/String;Ljava/lang/Class;Lf/k/d/f;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E::",
    ...
    .line 5
    invoke-virtual {p3, v0}, Lf/k/d/f;->onSuccess(Ljava/lang/Object;)V
    ...
    invoke-direct {v1, p0, p3, p1, p2}, Lzendesk/core/ZendeskSettingsProvider$2;-><init>(Lzendesk/core/ZendeskSettingsProvider;Lf/k/d/f;Ljava/lang/String;Ljava/lang/Class;)V

    invoke-direct {p0, v0, v1}, Lzendesk/core/ZendeskSettingsProvider;->getSettingsInternal(Ljava/util/Locale;Lf/k/d/f;)V
